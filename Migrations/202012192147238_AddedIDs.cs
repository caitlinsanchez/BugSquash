namespace BugSquash.Migrations
{
    ...
    public partial class AddedIDs : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Tickets", "TicketPriorityId", c => c.Int(nullable: true));
            AlterColumn("dbo.Tickets", "TicketStatusId", c => c.Int(nullable: true));
            AlterColumn("dbo.Tickets", "TicketTypeId", c => c.Int(nullable: true));
